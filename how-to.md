	...
	<div class="row">
	 ...
	 <a class="btn btn-danger" href="painting-convicts/">Find Out How</a>
	  ...
	  <div class="col-md-4">
	   ...
	   <a href="http://dreadballxtremethegame.com/how-to/painting-kalyshi/"> <img src="../img/kalyshi002.png" /> class="pull-left img-responsive"</a>
	    <a class="btn btn-danger" href="painting-kalyshi/">Find Out How</a>
	  </div>
	  <!-- /.col-md-4 -->
	  <div class="col-md-4">
	    <h3>Painting Free Agents</h3>
	     <img src="../img/avaran-thing.png" /> class="pull-left img-responsive"
	    <a class="btn btn-default" href="#">Coming Soon</a>
	  </div>
	  <!-- /.col-md-4 -->
	</div>
